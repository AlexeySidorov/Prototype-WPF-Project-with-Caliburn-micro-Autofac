...
namespace Task2
{
    public class AutofacBootstrapper<TRootViewModel> : BootstrapperBase
    {
        ...
        public Func<IRestApi> CreateRestApiRequest { get; set; }
        ...
        { //  allow base classes to change bootstrapper settings
            ...
            if (CreateEventAggregator == null)
                // ReSharper disable once NotResolvedInText
                throw new ArgumentNullException("CreateRestApiRequest");
            ...
            {
                typeof (TRootViewModel).Assembly
            };

            //var ass = AppDomain.CurrentDomain.GetAssemblies().ToArray();
            ...
            builder.Register(c => CreateRestApiRequest()).InstancePerLifetimeScope();
        ...
        { //  by default, enforce the namespace convention
            ...
            CreateRestApiRequest = () => new RestApi();
        }
        /// <summary>
